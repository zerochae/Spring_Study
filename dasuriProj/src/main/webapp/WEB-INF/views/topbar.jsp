...
<%
EmpVO empVO = (EmpVO)session.getAttribute("EMPVO")==null? new EmpVO() : (EmpVO)session.getAttribute("EMPVO");
%>
	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item dropdown no-arrow"><a
			...
			aria-expanded="false"> <span
				class="mr-2 d-none d-lg-inline text-gray-600 small">${emp.nm}(${emp.empNo})</span> <img class="img-profile rounded-circle"
